...
namespace Agenda.banco
{
    class Banco_funcoes
    {
        ...
        public void InserirAluno(string nome, string ende, string fone, string idade, string cpf, string peso)
        {
            conexao.Query<Alunos>("INSERT INTO alunos (Nome,Ende,Fone,Idade,cpf,peso) " +
                "VALUES('" + nome + "','" + ende + "','" + fone + "'," + idade + "'," + cpf + "'," + peso + ")");
        ...
        public void EditarAluno(string id, string nome, string ende, string fone, string idade, string cpf, string peso)
        {
            conexao.Query<Alunos>("UPDATE alunos SET Nome = '" + nome + "', Ende = '" + ende + "', Fone = '" + fone + "', Idade = '"
                + idade + "', Cpf = '" + cpf + "', Peso = '" + peso + "', WHERE Id = '" + id + "' ");
